    ...
    <div class="sb-scroll">
        ...
        <div class="sb-section">
            ...
            <div class="sb-section-body">
                ...
                class="sl-link {{ request()->routeIs('admin.contract-types.*') ? 'active' : '' }}"
                data-label="Contract Types">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                    <span class="sl-link-text">Contract Types</span>
                </a>
            </div>
        </div>
        ...
        <div class="sb-section">
            ...
            <div class="sb-section-body">
                ...
                data-label="Test Fees">
                    ...
                    <span class="sl-link-text">Test</span>
                </a>
            ...
            <div class="sb-section-body">
                ...
                <a href="{{ route('admin.installments.index') }}"
                   ...
                   data-label="Installments">
                    ...
                    <span class="sl-link-text">Installment Requests</span>
                ...
                <a href="{{ route('admin.refunds.index') }}"
                   ...
                   data-label="Refunds">
                    ...
                    <span class="sl-link-text">Refund Requests</span>
                    @if($pendingRefunds > 0)
                ...
                <a href="{{ route('admin.outstanding.index') }}"
                   ...
                   data-label="Outstanding">
                    ...
                    <span class="sl-link-text">Outstandings</span>
                </a>
