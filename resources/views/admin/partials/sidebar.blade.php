<aside style="width:220px;flex-shrink:0;background:rgba(255,255,255,0.85);
    ...
    <a href="{{ route('admin.rooms.index') }}" class="sl-link {{ request()->routeIs('admin.rooms.*') ? 'active' : '' }}">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
        Rooms
    </a>
    <a href="{{ route('admin.materials.index') }}" class="sl-link {{ request()->routeIs('admin.materials.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.english-levels.index') }}" class="sl-link {{ request()->routeIs('admin.english-levels.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.packages.index') }}" class="sl-link {{ request()->routeIs('admin.packages.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.bundles.index') }}" class="sl-link {{ request()->routeIs('admin.bundles.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.refunds.index') }}" class="sl-link {{ request()->routeIs('admin.refunds.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.sales.index') }}" class="sl-link {{ request()->routeIs('admin.sales.*') ? 'active' : '' }}">
    ...
    {{-- Reports --}}
    <a href="{{ route('admin.reports.index') }}" class="sl-link {{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">
