                    ...
                    <label class="assign-instance-card {{ $isDisabled ? 'is-full' : '' }}"
                        ...
                        <div class="assign-card-info">
                            <div class="assign-card-name">
                                ...
                                @php
                                    $lvlName = $instance->level?->name;
                                    $subName = $instance->sublevel?->name;
                                @endphp
                                @if($lvlName || $subName)
                                    <span style="font-weight:400;color:#7A8A9A;font-size:11px;">
                                        — {{ $lvlName ?? '—' }}@if($subName) · {{ $subName }}@endif
                                    </span>
                                @endif
                            </div>
                            <div class="assign-card-meta">
                                ...
                                @if($instance->type === 'Private')
                                    <span style="display:inline-flex;align-items:center;font-size:9px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;color:#C47010;background:rgba(245,145,30,0.08);border:1px solid rgba(245,145,30,0.2);padding:2px 8px;border-radius:4px;">Private</span>
                                @else
                                    <span style="display:inline-flex;align-items:center;font-size:9px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;color:#1B4FA8;background:rgba(27,79,168,0.08);border:1px solid rgba(27,79,168,0.2);padding:2px 8px;border-radius:4px;">Group</span>
                                @endif
                                <span>·</span>
