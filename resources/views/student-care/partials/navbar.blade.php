...
<div class="amobile-menu" id="amobileMenu">
    ...
    <div class="amobile-user">
        ...
        <div style="min-width:0;">
            ...
            <div style="font-size:9px;letter-spacing:2px;text-transform:uppercase;color:#C47010;">Student Care</div>
        </div>
    </div>
    ...
    <div class="amobile-scroll">
        ...
        <div class="amgroup" data-group>
            ...
            <div class="amgroup-body">
                <a href="{{ route('student-care.dashboard') }}" class="amobile-nav-link {{ request()->routeIs('student-care.dashboard') ? 'active' : '' }}">
        ...
        <div class="amgroup" data-group>
            ...
            <div class="amgroup-body">
                <a href="{{ route('student-care.waiting-list') }}" class="amobile-nav-link {{ request()->routeIs('student-care.waiting-list') ? 'active' : '' }}" data-label="Waiting List">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                    <span class="amobile-nav-link-text">Waiting List</span>
                </a>
            </div>
        </div>
        ...
        <div class="amgroup" data-group>
            ...
            <div class="amgroup-body">
                <a href="{{ route('student-care.instances') }}" class="amobile-nav-link {{ request()->routeIs('student-care.instances') ? 'active' : '' }}" data-label="Active Courses">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                    <span class="amobile-nav-link-text">Active Courses</span>
                </a>
                <a href="{{ route('student-care.instances.create') }}" class="amobile-nav-link {{ request()->routeIs('student-care.instances.create') ? 'active' : '' }}" data-label="Create Course">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
                    <span class="amobile-nav-link-text">Create New Course</span>
                </a>
                <a href="{{ route('student-care.outstanding') }}" class="amobile-nav-link {{ request()->routeIs('student-care.outstanding') ? 'active' : '' }}" data-label="Outstanding">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    <span class="amobile-nav-link-text">Outstanding</span>
                </a>
                <a href="{{ route('student-care.postponed') }}" class="amobile-nav-link {{ request()->routeIs('student-care.postponed') ? 'active' : '' }}" data-label="Postponed">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    <span class="amobile-nav-link-text">Postponed</span>
                </a>
