<nav x-data="{ open: false, scrolled: false }"
    ...
    <style>
        ...
        .nav-student-care-pill::before {
            content: ''; position: absolute; inset: 0;
            background: linear-gradient(90deg, #1B4FA8, #2D6FDB);
            transform: scaleX(0); transform-origin: left;
            transition: transform 0.4s cubic-bezier(0.16,1,0.3,1);
        }
        .nav-student-care-pill:hover::before,
        .nav-student-care-pill.active::before { transform: scaleX(1); }
        .nav-student-care-pill:hover,
        .nav-student-care-pill.active { color: #fff; border-color: transparent; text-decoration: none; }
        .nav-student-care-pill > * { position: relative; z-index: 1; }
    </style>
