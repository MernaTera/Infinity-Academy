...
<div class="inf-modal" id="invoicePanel">
    ...
    <div class="inf-modal-header">
        ...
        <div class="inf-header-actions">
            ...
            <button type="button" class="inf-print-btn" onclick="window.open('{{ route('cs.enrollment.receipt', $enrollment->enrollment_id) }}','receipt_{{ $enrollment->enrollment_id }}','width=380,height=650,menubar=no,toolbar=no,location=no')">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="4" width="16" height="16" rx="1"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="12" y2="17"/></svg>
                <span>Receipt</span>
            </button>
