<nav x-data="{ open: false, scrolled: false }"
    ...
    <style>
        ...
        .nav-link-item:hover,
        .nav-link-item.active { color: #1B4FA8; }
        ...
        .nav-dropdown-panel {
            ...
            border-radius: 6px;
            box-shadow: 0 12px 40px rgba(27,79,168,0.1);
            overflow: hidden;
        }
        .nav-dropdown-item {
            display: block;
        ...
        .nav-avatar {
            ...
            border: 1.5px solid rgba(27,79,168,0.2);
    ...
    <div class="mx-auto px-6 lg:px-8 mx-4">
        ...
        <div class="logo-wrap">
                    ...
                    <x-slot name="trigger">
                        <button class="flex items-center gap-3" style="background:none;border:none;cursor:pointer;outline:none;">
                            ...
                            <div class="flex flex-col items-start leading-none">
                                <span style="font-size:12px;font-weight:500;color:#1A2A4A;letter-spacing:0.3px;">
                                    {{ Auth::user()->name }}
                                </span>
                                <span style="font-size:9px;letter-spacing:2px;text-transform:uppercase;color:#AAB8C8;margin-top:2px;">
                                    Administrator
                                </span>
                            </div>
            ...
            {{-- ── HAMBURGER ── --}}
            <button @click="open = !open" class="sm:hidden flex flex-col gap-[5px] p-2"
                    style="background:none;border:none;cursor:pointer;">
                <span class="hamburger-line"
                      :style="open ? 'transform:translateY(6.5px) rotate(45deg);background:#1B4FA8' : ''"></span>
                <span class="hamburger-line"
    ...
    <div x-show="open"
        ...
        {{-- Nav links --}}
        <div style="padding:12px 24px;display:flex;flex-direction:column;">
            <a href="{{ route('dashboard') }}"
               style="font-size:11px;letter-spacing:3px;text-transform:uppercase;
                      ...
                      border-bottom:1px solid rgba(27,79,168,0.05);">
                Dashboard
            </a>
        </div>
        ...
        <div style="padding:16px 24px;border-top:1px solid rgba(27,79,168,0.07);">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
                <div class="nav-avatar" style="width:38px;height:38px;">
                    <span style="font-family:'Bebas Neue',sans-serif;font-size:15px;color:#1B4FA8;">
                        {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                    </span>
                </div>
                <div>
            ...
            <a href="{{ route('profile.edit') }}"
               style="display:block;font-size:11px;letter-spacing:3px;text-transform:uppercase;
                      color:#7A8A9A;padding:10px 0;text-decoration:none;
                      border-bottom:1px solid rgba(27,79,168,0.05);">
                Profile
            </a>
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                        style="width:100%;text-align:left;background:none;border:none;
                               ...
                               color:#DC2626;padding:10px 0;cursor:pointer;
                               font-family:'DM Sans',sans-serif;">
                    Log Out
                </button>
            </form>
