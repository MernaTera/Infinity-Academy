                        ...
                        <td>
                            <div class="action-group">
                                ...
                                <button class="btn-action"
                                        ...
                                        style="color:#7A8A9A;border-color:rgba(85, 153, 100, 0.25);"
                                        onmouseover="this.style.background='rgba(98, 179, 134, 0.07)';this.style.borderColor='#74ad6f'"
                                        onmouseout="this.style.background='';this.style.borderColor='rgba(122, 154, 127, 0.25)'">
                                    <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                                        <polyline points="14 2 14 8 20 8"/>
                                        <line x1="16" y1="13" x2="8" y2="13"/>
